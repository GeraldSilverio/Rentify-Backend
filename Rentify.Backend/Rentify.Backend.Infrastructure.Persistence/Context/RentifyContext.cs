...
using Rentify.Backend.Infrastructure.Persistence.EntityConfiguration.Core;
using Rentify.Backend.Infrastructure.Persistence.EntityConfiguration.Customers;
using Rentify.Backend.Infrastructure.Persistence.EntityConfiguration.Events;
using Rentify.Backend.Infrastructure.Persistence.EntityConfiguration.Locations;
using Rentify.Backend.Infrastructure.Persistence.EntityConfiguration.Payments;
using Rentify.Backend.Infrastructure.Persistence.EntityConfiguration.Reservations;
using Rentify.Backend.Infrastructure.Persistence.EntityConfiguration.Vehicles;

namespace Rentify.Backend.Infrastructure.Persistence.Context
{
