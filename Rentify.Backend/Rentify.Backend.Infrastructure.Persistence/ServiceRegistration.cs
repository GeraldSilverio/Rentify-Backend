...
using Rentify.Backend.Infrastructure.Persistence.Repositories.Core;
using Rentify.Backend.Infrastructure.Persistence.Repositories.Locations;
using Rentify.Backend.Infrastructure.Persistence.Repositories.Vehicules;

namespace Rentify.Backend.Infrastructure.Persistence
{
    public static class ServiceRegistration
    {
        public static void AddPersistence(this IServiceCollection services, IConfiguration configuration)
        {
            ...
            services.AddScoped<IVehicleUnavailableDateRepository, VehicleUnavailableDateRepository>();
