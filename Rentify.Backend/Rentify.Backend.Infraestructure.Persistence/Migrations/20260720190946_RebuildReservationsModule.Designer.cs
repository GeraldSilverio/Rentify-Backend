...
namespace Rentify.Backend.Infraestructure.Persistence.Migrations
{
    ...
    [Migration("20260720190946_RebuildReservationsModule")]
    partial class RebuildReservationsModule
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Rentify.Backend.Core.Domain.Entities.Customers.Customer", b =>
                {
                    ...
                    b.Property<string>("IdentificationNumberNormalized")
                        .IsRequired()
                        .HasMaxLength(30)
                        .HasColumnType("character varying(30)");
                    ...
                    b.HasIndex("TenantId", "IdentificationType", "IdentificationNumberNormalized")
                        .IsUnique()
            ...
            modelBuilder.Entity("Rentify.Backend.Core.Domain.Entities.Locations.Location", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
                    ...
                    b.HasIndex("Name", "City", "Province", "Country")
                        .IsUnique()
                        .HasFilter("\"IsDeleted\" = false");
            ...
            modelBuilder.Entity("Rentify.Backend.Core.Domain.Entities.Locations.TenantLocation", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");

                    b.Property<bool>("AllowsDelivery")
                        .HasColumnType("boolean");
            ...
            modelBuilder.Entity("Rentify.Backend.Core.Domain.Entities.Reservations.Reservation", b =>
                {
                    ...
                    b.Property<DateTime?>("ConvertedToRentalAt")
                        .HasColumnType("timestamp with time zone");

                    b.Property<string>("ConvertedToRentalBy")
                        .HasMaxLength(150)
                        .HasColumnType("character varying(150)");
                    ...
                    b.Property<string>("DeliveryAddressDetails")
                        .HasMaxLength(500)
                        .HasColumnType("character varying(500)");
                    ...
                    b.Property<Guid?>("DeliveryTenantLocationId")
                        .HasColumnType("uuid");
                    ...
                    b.Property<string>("ReturnAddressDetails")
                        .HasMaxLength(500)
                        .HasColumnType("character varying(500)");
                    ...
                    b.Property<Guid?>("ReturnTenantLocationId")
                        .HasColumnType("uuid");
                    ...
                    b.Property<bool>("SecurityDepositRequired")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("boolean")
                        .HasDefaultValue(false);
                    ...
                    b.HasIndex("DeliveryTenantLocationId");

                    b.HasIndex("ReturnTenantLocationId");
                    ...
                    b.HasIndex("TenantId", "DeliveryDateTime");

                    b.HasIndex("TenantId", "ExpectedReturnDateTime");

                    b.HasIndex("TenantId", "Status");

                    b.HasIndex("TenantId", "VehicleId");

                    b.HasIndex("TenantId", "VehicleId", "DeliveryDateTime", "ExpectedReturnDateTime");
            ...
            modelBuilder.Entity("Rentify.Backend.Core.Domain.Entities.Locations.TenantLocation", b =>
                {
                    b.HasOne("Rentify.Backend.Core.Domain.Entities.Locations.Location", "Location")
                        .WithMany()
            ...
            modelBuilder.Entity("Rentify.Backend.Core.Domain.Entities.Payments.Invoice", b =>
                {
                    ...
                    b.HasOne("Rentify.Backend.Core.Domain.Entities.Reservations.Reservation", null)
                        .WithMany()
